...
export CUDA_VISIBLE_DEVICES=0
./src/run_one_chatbot.sh 2 python -u ./src/translate.py --save_states=False --vocab_size=90000 --size=1800 --num_layers=2 --use_lstm=True --batch_size=64 --max_running_time=55 --embedding_dimensions=300 --checkpoint_dir="../checkpoints/2" --summary_path="../data/summaries/2" >> $EXP_PATH/log/log2.txt
